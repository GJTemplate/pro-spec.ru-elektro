...
<div itemscope itemtype="http://schema.org/Product" class="product productitem_<?php echo $product->product_id?>">
  <div class="b1c-good">
	<div class="my_image_block">
        ...
        <div class="image_block">
            ...
            <a href="<?php echo $product->product_link?>">
                <img class="jshop_img" src="<?php echo $product->image?>" alt="Купить <?php echo $product->name?> в <?php echo$_COOKIE['city_name']?>" itemprop="image"  title="<?php echo $product->name?>" />
            </a>
        </div>
        <?php }?>
		<div style="">
	...
	<div class="name">
            <div class="product_title"><a href="<?php echo $product->product_link?>"><span itemprop="name"><?php echo $product->name?></span></a></div>
        ...
        <?php }?>
         ...
         <?php if ($product->product_price !=0){?>
                 ...
                 <span class="price-name" >Цена: </span> <span itemprop="price"><?php echo formatprice($product->product_price);?></span>
		...
		<div style="" abbr class="jcetooltip" title="Заполните форму заявки и наши менеджеры свяжутся с вами."><input class="b1c" type="button" style="float: none; text-shadow: none; margin: 10px auto; height: 30px; font-size: 13px; border: medium none; background: #ff7800; color: #ffffff; text-transform: uppercase;"
		<?php if (!($category_id == '857' || $category_id == '858' || $category_id == '859' || $category_id == '893' || $category_id == '1060' || $category_id == '1179' )) {?>
